...
if(request.getParameter("submit")!=null)
{
    ...
    Cookie password = new Cookie("password", request.getParameter("password"));
     ...
     response.sendRedirect("http://localhost:8080/schoolManagement/teacherPanel.jsp");
...
<body>
	<div class="content">
      ...
      <div class="text">Teacher Login Form</div>
      <form action="teacherPanel.jsp" method="post" onsubmit="return validate()">
        <div class="field">
